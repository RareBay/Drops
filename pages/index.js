      ...
      />
          ...
          <div className="home-hero-content">
            <div className="home-header-container">
              ...
              BITCOIN-LIKE AND FULLY DECENTRALIZED PROTOCOL LAYER MADE BY WHALES, FOR WHALES. BUILT ON CORE. A BITCOIN HASH POWRED AND EVM COMPATIBLE BLOCKCHAIN USING THE SATOSHI+ CONSESUS MECHANISIM TO ENSURE A SECURE, SCALABLE AND DECENTRALIZED ENVIRONMENT
              </div>
            </div>
            {!user? (
              <>
